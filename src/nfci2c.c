...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initnfci2c(void); /*proto*/
PyMODINIT_FUNC initnfci2c(void)
#else
PyMODINIT_FUNC PyInit_nfci2c(void); /*proto*/
PyMODINIT_FUNC PyInit_nfci2c(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static int __pyx_pymod_exec_nfci2c(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_nfci2c(void)", 0);
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init nfci2c", 0, __pyx_lineno, __pyx_filename);
    }
